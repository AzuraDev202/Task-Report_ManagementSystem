...
import { FiArrowLeft, FiFile, FiX, FiUpload } from 'react-icons/fi';
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600">Báo cáo tiến độ công việc</p>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={8}
              required
              placeholder="Mô tả chi tiết về công việc đã thực hiện, kết quả đạt được, khó khăn..."
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              required
            >
              <option value="draft">Nháp (Lưu tạm)</option>
              <option value="submitted">Nộp để duyệt</option>
            </select>
            <p className="text-sm text-gray-500 mt-1">
              Chọn "Nháp" để lưu tạm, "Nộp để duyệt" để gửi báo cáo cho quản lý
            </p>
          </div>
          ...
          <div className="flex gap-3 pt-4">
            ...
            >
              {loading ? 'Đang tạo...' : formData.status === 'submitted' ? 'Tạo và nộp báo cáo' : 'Lưu nháp'}
            </button>
